<div class="row">   
    ...
    <div class="form-group col-lg-4 mb-3">
        {{ Form::label('stage') }}
        {{ Form::select('stage', ['Pipeline/Identification'=>'Pipeline/Identification','Implementation'=>'Implementation','Finalisation'=>'Finalisation','Closed'=>'Closed','Cancelled'=>'Cancelled','Suspended'=>'Suspended'], $project->stage, ['class' => 'form-control select' . ($errors->has('stage') ? ' is-invalid' : ''), 'placeholder' => '--Select--']) }}
