...
<div class="page-header-content d-lg-flex">
    <div class="d-flex">
        <h4 class="page-title mb-0">
            Home - <span class="fw-normal">Activity Site Management</span>
        </h4>
    </div>
    <div class="d-lg-block my-lg-auto ms-lg-auto">
        <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
            @can('activitySite-create')
...
<div class="col-sm-12">
    <div class="card">
        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                @foreach ($activity->sites as $key => $row)
                    @php($site = $row->site)
                    <tr>
                        <td>{{ ++$key }}</td>
                        <td>{{ $site->name }}</td>
                        ...
                        <td class="text-center">
                            <form action="{{ route('activities.sites.destroy',$row->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                @can('activitySite-delete')
...
@include('admin.activities.site.create')
@endsection
...
<script>
    $(function () {
        ...
        function remoteSettings(elementId) {
            return {
                url: "{{ route('activities.sites.checkRecord') }}",
                type: "POST",
                data: {
                    _token,
