...
<div class="page-header-content d-lg-flex">
    <div class="d-flex">
        <h4 class="page-title mb-0">
            Home - <span class="fw-normal">Activity Stakeholder Management</span>
        </h4>
    </div>
    <div class="d-lg-block my-lg-auto ms-lg-auto">
        <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
            @can('activityStakeholder-create')
...
<div class="col-sm-12">
    <div class="card">
        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                @foreach ($activity->stakeholders as $key => $row)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('activities.stakeholder.destroy',$row->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                @can('activityStakeholder-delete')
...
@include('admin.activities.stakeholder.create')
@endsection
...
<script>
    $(function () {
        ...
        function remoteSettings(elementId) {
            return {
                url: "{{ route('activities.stakeholder.checkRecord') }}",
                type: "POST",
                data: {
                    _token,
