...
<div class="page-header-content d-lg-flex">
    <div class="d-flex">
        <h4 class="page-title mb-0">
            Home - <span class="fw-normal">Activity Files Management</span>
        </h4>
    </div>
    <div class="d-lg-block my-lg-auto ms-lg-auto">
        <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
            @can('activityFile-create')
...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Activity Files</h5>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered table-lg">
                <tbody>
                    ...
                    @forelse($activity->files as $key => $file)
                        <tr>
                            <td>{{ ++$key }}</td>
                            <td>{{ $file->name }}</td>
                            <td>{{ $file->path }}</td>
                            <td>{{ Carbon\Carbon::parse($file->created_at)->format('d M Y') }}</td>
                            <td class="text-center">@include('admin.activities.file.actions')</td>
                        </tr>
                    @empty
                        <tr align="center">
...
@include('admin.activities.file.create')
@include('admin.activities.file.edit')
@endsection
