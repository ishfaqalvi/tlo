...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Follow-up Needed</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-9">
                ...
                <div class="col-sm-3">
                    <div class="form-group mb-3">
                        ...
                        {{ number_format($needBase['Yes']) }}
                    </div>
                    <div class="form-group mb-3">
                        <strong>Follow-up Not Needed:</strong>
                        {{ number_format($needBase['No']) }}
                    </div>
                </div>
            </div>
        </div>
        ...
        var _scatterPieBasicLightExample = function() {
            ...
            pie_basic.setOption({
                ...
                series: [{
                    ...
                    data: [
                        {value: "{{ $needBase['Yes'] }}", name: 'Yes'},
                        {value: "{{ $needBase['No'] }}", name: 'No'}
                    ]
                }]
            });
            // Resize function
