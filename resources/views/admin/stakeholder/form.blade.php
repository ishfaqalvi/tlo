<div class="row">
    ...
    <div class="form-group col-lg-6 mb-3">
        {{ Form::label('role') }}
        {{ Form::select('stakeholder_role_id', stakeholderRoles(), $stakeholder->stakeholder_role_id, ['class' => 'form-control select' . ($errors->has('stakeholder_role_id') ? ' is-invalid' : ''), 'placeholder' => '--Select--','required']) }}
        {!! $errors->first('stakeholder_role_id', '<div class="invalid-feedback">:message</div>') !!}
    </div>
    <div class="form-group col-lg-6 mb-3">
        {{ Form::label('province') }}
